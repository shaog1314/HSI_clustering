function [sol, info,cost] = prox_tv_19(b, gamma, param)
%
% Note : this code is from the unlockbox toolbox, with deleting some
% unnecessary lines for simplification, meanwhile an box constriant is
% enforced
%
...
if ~isfield(param, 'tol'), param.tol = 10e-7; end
