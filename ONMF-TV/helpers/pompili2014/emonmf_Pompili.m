function [labels,centroids,relError,iter,U_binarized] = emonmf_Pompili(M,initClusts,MaxIters,initMethod)
...
elseif size(initClusts,1) == numItems && size(initClusts,2) == 1
    ...
    areInitCentroidsGiven = 1;%Corrected line of code here!
    maxRestarts = 0;
