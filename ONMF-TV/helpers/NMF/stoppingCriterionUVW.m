function [flag, updateChange, numEqualInARowNew, stoppingCause] = stoppingCriterionUVW(iii,U,U2,V,V2,W,W2,param,numEqualInARow)
...
%W:                 New auxiliary matrix iteration
%W2:                Old auxiliary matrix iteration
%param:             Struct, which contains all predefined hyperparameters.
%numEqualInARow:    Number of times that the cluster membership
...
% This code comes with no guarantee or warranty of any kind.
    ...
    updateChange.W = norm(W-W2, 'fro')/norm(W2, 'fro');
    ...
    switch param.stoppingCrit
        case 'relChange'
            ...
            if iii >= param.maxIt
                ...
                stoppingCause = 'maxIt';
            elseif mod(iii,2) == 0
                if updateChange.U < param.stopLimUVW &&...
                        updateChange.V < param.stopLimUVW && updateChange.W < param.stopLimUVW 
                  flag = true;
