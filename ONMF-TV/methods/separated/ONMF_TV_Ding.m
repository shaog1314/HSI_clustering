function [U,UTV,V,clusterQuality,timeNeeded]=ONMF_TV_Ding(pathToSaveResults, numClusters, tauTV, iniType, indexParam, whichData, dataPath)
%Computes the (orthogonal) NMF with orthogonal constaints based on Ding,
%C.; Li, T.; Peng, W.; Park, H. Orthogonal Nonnegative Matrix
%T-Factorizations for Clustering. Proceedings of the 12th ACM
...
%     data.name = datasetName;
    ...
    param.maxIt             = 800;   %Maximal Iteration Number
    %TV Regularization
    param.tauTV = tauTV;
...
%     end
    ...
    %% NMF Iterations
    reverseStr='';
    fprintf('Starting the NMF Iterations based on Ding et al.\n')
    fprintf('Progress:\n')
